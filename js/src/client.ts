...
export class AuthClient {
     ...
     * @param turnstileToken - Cloudflare Turnstile token. Required when the tenant has bot protection enabled for login.
     */
    async loginWithPassword(email: string, password: string, turnstileToken?: string): Promise<User | MFARequiredResult> {
    ...
    async loginWithCredentials(email: string, password: string, turnstileToken?: string): Promise<User> {
        const result = await this.loginWithPassword(email, password, turnstileToken)
     ...
     * @param turnstileToken - Cloudflare Turnstile token. Required when bot protection is enabled for password reset.
     */
