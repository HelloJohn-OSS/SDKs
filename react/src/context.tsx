...
interface AuthContextType {
    ...
    loginWithCredentials: (email: string, pass: string, turnstileToken?: string) => Promise<void>;
...
export function AuthProvider({
    ...
    const loginWithCredentials = async (email: string, pass: string, turnstileToken?: string) => {
        if (!client) return;
        const u = await client.loginWithCredentials(email, pass, turnstileToken);
        setUser(u);
        setIsAuthenticated(true);
    };
